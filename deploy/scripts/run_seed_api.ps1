...
# Ejecutar seed_api.js dentro del contenedor customers-api
Send-CommandDirect "sudo docker cp /home/dylan/praEXAM/deploy/seed/seed_api.js boreal-customers-api:/app/seed_api.js && sudo docker exec boreal-customers-api node /app/seed_api.js"
