...
# Ejecutar seed dentro del contenedor de la VM
Send-CommandDirect "sudo docker cp deploy/seed/seed.js boreal-customers-api:/app/seed.js && sudo docker exec boreal-customers-api node /app/seed.js"
