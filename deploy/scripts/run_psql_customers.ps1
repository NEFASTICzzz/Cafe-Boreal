...
# Ejecutar el SQL con psql dentro del contenedor postgres
Send-CommandDirect "sudo docker exec -i boreal-postgres psql -U boreal_user -d boreal_db -f /home/dylan/praEXAM/deploy/seed/insert_valid_customers.sql"
