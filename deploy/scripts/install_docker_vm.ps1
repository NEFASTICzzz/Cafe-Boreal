...
# Dar permisos de ejecucion y correr docker-compose / script
Send-VMCommand "chmod +x deploy/scripts/*.sh deploy/backup/*.sh git_setup.sh"
Start-Sleep -Seconds 1
Send-VMCommand "echo 1234 | sudo -S apt update && echo 1234 | sudo -S apt install -y docker.io docker-compose"
