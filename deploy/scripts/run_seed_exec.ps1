...
# Ejecutar seed.js nativo dentro del contenedor customers-api
Send-CommandDirect "sudo docker cp /home/dylan/praEXAM/deploy/seed/seed.js boreal-customers-api:/app/seed.js && sudo docker exec -e DB_HOST=postgres -e ENCRYPTION_KEY='boreal_secret_key_256bit_32B_len!' boreal-customers-api node /app/seed.js"
